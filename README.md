# Proof of Reserves Licensed to UZX Limited
## Background

UZX launches Proof of Reserve (PoR) to improve the security and transparency of user assets. These tools will allow you to independently audit UZX’s Proof of Reserves as well as verify that UZX’s reserves have exceed the exchange’s known liabilities to all users to confirm UZX’s solvency.
...
### 2. UZX Limited Merkle Tree Definition
